...
import { Zap, Loader2, WifiOff, Briefcase } from "lucide-react"
...
export function EssayTopicGrid() {
  ...
  return (
    <div className="flex flex-col gap-4">
      ...
      {/* Modo Empreendedor — CTA secundário */}
      <Link
        href="/essay/business-mode"
        className="group flex items-center gap-3 rounded-xl border border-[#ffd54f]/25 bg-[#ffd54f]/5 px-4 py-3 transition-all hover:border-[#ffd54f]/50 hover:bg-[#ffd54f]/10"
      >
        <div className="flex h-8 w-8 shrink-0 items-center justify-center rounded-lg bg-[#ffd54f]/15">
          <Briefcase className="h-4 w-4 text-[#ffd54f]" suppressHydrationWarning />
        </div>
        <div className="flex-1 min-w-0">
          <p className="text-sm font-bold text-[#ffd54f] leading-none">
            Redação & Negócios: Saindo do Zero
          </p>
          <p className="text-[10px] text-neutral-500 mt-0.5">
            Use a redação para criar um plano de negócio real · R$ 0 investimento
          </p>
        </div>
        <span className="font-mono text-[10px] text-[#ffd54f]/50 shrink-0">NOVO</span>
      </Link>
